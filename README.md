...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/retroix@0.1.0/retroix.css">
<script src="https://cdn.jsdelivr.net/npm/retroix@0.1.0/retroix.js"></script>
```

Or from the GitHub repo (no npm needed):

```html
<script src="https://cdn.jsdelivr.net/gh/DanMat/Retroix@v0.1.0/retroix.js"></script>
```
